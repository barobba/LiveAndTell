...
<body class="<?php print $classes; ?>">
  ...
  <!-- JUMP TO NAVIGATION (BEFORE PAGE LEADER TO ENSURE POSITION AT TOP) -->
  <?php if ($primary_links): ?>
    <div id="skip-link"><a href="#main-menu"><?php print t('Jump to Navigation'); ?></a></div>
  <?php endif; ?>

  <!-- PAGE LEADER (OPPOSITE OF CLOSURE) -->
  <?php print $page_leader ?>
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="header"><div class="section clearfix">
      ...
      <!-- USER OPTIONS -->
      <?php $user_options_links = menu_navigation_links('menu-user-options', 0) ?>
      <?php if (!empty($user_options_links)): ?>
        <?php print theme('links', $user_options_links, array('id' => 'user-links', 'class' => 'links')) ?>
      <?php endif; ?>
